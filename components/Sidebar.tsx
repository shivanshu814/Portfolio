...
const Sidebar = () => {
	return (
		<div>
			...
			/>
			<h1 className='my-4 text-3xl tracking-wider text-white font-delicious'>
				<span className='text-red-500'>Shivanshu</span> Pathak
			</h1>
			...
			<div
				...
				<p className='my-2'>9893628988 / 8595438920</p>
			</div>

			{/* contact */}
			<button
				className='w-8/12 px-5 py-2 my-1 text-white rounded-full bg-gradient-to-r from-orange-500 to-green-500 focus:outline-none'
				onClick={() => window.open('mailto:shivanshu814pathak@gmail.com')}>
				Email Me
			</button>
			{/* Theme */}
